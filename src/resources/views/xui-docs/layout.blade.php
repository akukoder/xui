        ...
        <div class="md:flex-col md:items-stretch md:min-h-full md:flex-no-wrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
            ...
            <div
                ...
                <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                    ...
                    <li class="inline-flex">
                        <a
                            class="text-{{ request()->is('xui-docs/alerts') ? 'pink-500' : 'gray-700' }} hover:text-{{ request()->is('xui-docs/alerts') ? 'pink-600' : 'gray-900' }} text-xs mb-4 font-semibold"
                            href="{{ URL::route('xui::alerts') }}">
                            <svg class="h-4 w-4 mr-2 -mt-1 {{ request()->is('xui-docs/alerts') ? 'pink-500' : 'gray-700' }} inline-block"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
